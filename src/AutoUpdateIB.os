...
Функция УстановитьБлокировкуСоединений(ПараметрыПодключения) Экспорт	
	...
	Если НЕ ПараметрыБлокировкиCеансов.БлокироватьСеансыИБ Тогда 	
		Лог.Информация(НСтр("ru = 'Блокировка сеансов пользователей информационной базы отключена.'"));
		Возврат Истина;
	КонецЕсли;
...
Функция СоздатьРезервнуюКопию(ПараметрыПодключения, ФайлРезервнойКопии = "") Экспорт
	...
	Если НЕ ПараметрыРезервногоКопирования.СоздаватьРезервнуюКопию Тогда 	
		Лог.Информация(НСтр("ru = 'Создание резервной копии информационной базы отключено.'"));
		Возврат Истина;
	КонецЕсли;
...
Функция ВосстановитьИзРезервнойКопии(ПараметрыПодключения, ФайлРезервнойКопии)
	...
	Если НЕ ПараметрыРезервногоКопирования.ВосстанавливатьИнформационнуюБазу Тогда 	
		Лог.Информация(НСтр("ru = 'Восстановление информационной базы из резервной копии отключено.'"));
		Возврат Истина;
	КонецЕсли;
